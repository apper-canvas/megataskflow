        ...
        >
          ...
          {tasks.length > 0 && (
            <div className="flex items-center space-x-2 mt-4 text-sm">
              <ApperIcon name="CalendarDays" size={16} className="text-primary" />
              <span className="font-medium text-surface-900">{tasks.length}</span>
              <span className="text-surface-500">upcoming tasks</span>
            </div>
          )}
        </motion.div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {taskGroups.length === 0 ? (
          <EmptyState
            ...
            description="All your future tasks will appear here. Stay organized by scheduling tasks in advance."
            icon="CalendarDays"
            ...
            {taskGroups.map((group, groupIndex) => (
              ...
              >
                ...
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="text-sm text-surface-500 bg-surface-50 px-2 py-1 rounded-full">
